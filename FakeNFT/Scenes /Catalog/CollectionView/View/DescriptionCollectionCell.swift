...
final class DescriptionCollectionCell: UICollectionViewCell {
    ...
    private func setupLayout() {
        NSLayoutConstraint.activate([
            ...
            creatorCollectionButton.trailingAnchor.constraint(lessThanOrEqualTo: contentView.trailingAnchor, constant: -16),
            ...
            descriptionCollectionLabel.bottomAnchor.constraint(lessThanOrEqualTo: contentView.bottomAnchor, constant: -24)
        ])
    }
